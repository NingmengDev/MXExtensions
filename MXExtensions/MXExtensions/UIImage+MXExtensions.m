...
#import "UIImage+MXExtensions.h"

#import <Accelerate/Accelerate.h>

@implementation UIImage (MXExtensions)
...
- (UIImage *)mx_resizedImageToFitInSize:(CGSize)boundingSize scaleIfSmaller:(BOOL)scale
{
    ...
    return [self mx_resizedImageToSize:dstSize];
}
...
{
    return [self mx_roundImageBaseSize:size withRadius:size.width / 2];
}
